...
pub_joint1 = rospy.Publisher('/iiwa/EffortJointInterface_J1_controller/command', Float64, queue_size=1)
pub_joint2 = rospy.Publisher('/iiwa/EffortJointInterface_J2_controller/command', Float64, queue_size=1)
pub_joint3 = rospy.Publisher('/iiwa/EffortJointInterface_J3_controller/command', Float64, queue_size=1)
pub_joint4 = rospy.Publisher('/iiwa/EffortJointInterface_J4_controller/command', Float64, queue_size=1)
pub_joint5 = rospy.Publisher('/iiwa/EffortJointInterface_J5_controller/command', Float64, queue_size=1)
pub_joint6 = rospy.Publisher('/iiwa/EffortJointInterface_J6_controller/command', Float64, queue_size=1)
pub_joint7 = rospy.Publisher('/iiwa/EffortJointInterface_J7_controller/command', Float64, queue_size=1)
sub = rospy.Subscriber("/iiwa/joint_states", JointState, subCB, queue_size=3)
rate = rospy.Rate(10)
...
class PPO:
	...
	def get_state(self):
		...
		while np.sum(s.oldJointP-s.jointP) ==0:
			print('Waiting for new joints position')
	...
	def reset(self):
		#ospy.wait_for_service('/gazebo/pause_physics')
		#pause()
		doPublish([0.0, -1.7671458676442586, 0.0, -0.39269908169872414, 0.0],pub_joint1,pub_joint2,pub_joint3,pub_joint4,pub_joint5,pub_joint6,pub_joint7)
